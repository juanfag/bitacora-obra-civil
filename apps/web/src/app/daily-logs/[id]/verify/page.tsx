...
export default function DailyLogVerificationPage() {
  return (
    <AuthGuard>
      <Suspense fallback={<VerificationLoading />}>
        <DailyLogVerificationContent />
      </Suspense>
    </AuthGuard>
  );
}

function DailyLogVerificationContent() {
    ...
    <main className="mx-auto max-w-3xl px-6 py-10">
      <div className="mb-6">
        ...
        <p className="mt-2 text-sm text-slate-600">
          Contrasta el código del PDF contra los registros digitales del sistema.
        </p>
      </div>
